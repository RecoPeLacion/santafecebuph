...
<section class="sf_founding">
    <div class="cntr">
        ...
        <div class="sf_founding--counter">
            <div class="sf_time">
                <div class="sf_timer" id="sf_days"></div>
                <div class="sf_timer" id="sf_hours"></div>
                <div class="sf_timer" id="sf_minutes"></div>
                <div class="sf_timer" id="sf_seconds"></div>
            </div>
        </div>
    </div>
</section>
